...
namespace SteelmakingExpanded.Structures.SmokeStack.BlockEntities;
    ...
    IGasConsumer
{
  ...
  public override void Initialize(ICoreAPI api)
  {
    ...
    if (api.Side == EnumAppSide.Server && _system.GetNetworkAt(Pos) == null)
      _system.AddNode(api.World.BlockAccessor, Pos, "gas");
  }
  ...
  {
    if (_system?.GetNetworkAt(Pos) is not GasNetwork gasNet)
      return 0f;
